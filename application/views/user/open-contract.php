...
<!--User Page Meta Tags-->
<title>Contract - <?php if(!empty($contract[0]['contract_id'])) { echo '#'.$contract[0]['contract_id']; } ?> | <?php echo $this->lang->line('site_name') ?>| User Dashboard</title>
<meta charset="utf-8">
	...
	<div class="dashboard-content-container" data-simplebar>
		<div class="dashboard-content-inner" >
			...
			<div class="dashboard-headline">
				<h3>Open Contract With You & <a href="<?php echo current_url(); ?>"><?php if(isset($contract[0]['firstname'])) echo $contract[0]['firstname'] ?> <?php if(isset($contract[0]['lastname'])) echo $contract[0]['lastname']; ?></a></h3>
								...
								<div class="buttons-to-right always-visible margin-top-25 margin-bottom-0">
									<?php if ($contract[0]['status'] === '0' ){
										if($contract[0]['customer_id'] === $this->session->userdata('user_id')) { ?>
											<a href="<?php echo base_url().'checkout/'.'contract'.'/'.$contract[0]['id']; ?>" class="text-warning"><i class="mdi mdi-credit-card-scan"></i> P a y   N o w</a>
									<?php } } ?>
					...
					<div class="dashboard-box margin-top-0">
						...
						<div class="container-timeleft" id="container">
							...
							<div class="button-group" id="action">
								<a href="#small-dialog-6" data-contractid="<?php if(isset($contract[0]['id'])) echo $contract[0]['id']; ?>" class="popup-with-send-message button dark ripple-effect"><i class="mdi mid-hand-okay"></i> Cancel Contract</a>
							</div>
							<?php } ?>
						</div>
