			...
			<div class="sidebar-container">
				...
				<div class="sidebar-widget">
					<div class="bidding-widget">
						<div class="bidding-headline centerButtons"><h3><?php echo strtoupper('Make an offer !');  ?></h3></div>
						...
						<?php if($listing_data[0]['status'] !== '5') {
							...
							<!-- Price Slider -->
							<div class="bidding-value">$ <?php if(!empty($listing_data[0]['website_minimumoffer'])) echo number_format($listing_data[0]['website_minimumoffer']); else echo 0; ?></div>

							<?php if($listing_data[0]['user_id'] !== $this->session->userdata('user_id')) { ?>
							<!-- Button Make Offer-->
							<a href="#small-dialog-6" class="button ripple-effect move-on-hover full-width margin-top-20 popup-with-zoom-anim"><?php echo strtoupper('Make Offer');  ?> <i class="icon-material-outline-arrow-right-alt"></i></a>
							<?php } ?>
