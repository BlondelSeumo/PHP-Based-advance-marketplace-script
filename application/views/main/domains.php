    ...
    <div class="container">
        <div class="row slippa-breadcump-height align-items-center">
            <div class="col-lg-12 mx-auto text-center text-white">
                <h4 class="f-size-70 f-size-lg-50 f-size-md-40 f-size-xs-24 slippa-strong"><?php echo $this->lang->line('lang_bred_domains_page_main'); ?></h4>
                <h4 class="f-size-36 f-size-lg-30 f-size-md-24 f-size-xs-16 slippa-light3"><?php echo $this->lang->line('lang_bred_domains_page_sub'); ?></h4>
...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        <p class="lead"><?php echo $this->lang->line('lang_domains_category_p'); ?></p>
