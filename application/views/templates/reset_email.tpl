                      ...
                      <center>
                        <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="60%">
                          <tr>
                            ...
                            <br>
                             We're sure you will feel right at home with {{ sitename }}. Have you made a request to reset your password? .Please click on the following link and reset your password, if not please ignore this email.
                            <br>
                            <br>
                            </td>
                          </tr>
                ...
                <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="100%" bgcolor="#f5774e">
                      ...
                      <center>
                        <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="60%">
                          <tr>
                            ...
                            <br>
                              Faster download speeds and API solutions for all users!
                  ...
                  <tr>
                    <td>
                      ...
                      style="background-color:#ac4d2f;border-radius:4px;color:#ffffff;display:inline-block;font-family: Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;line-height:50px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Contact Us</a>
                        <!--[if mso]>
                          </center>
                        </v:roundrect>
                      <![endif]--></div>
                ...
                <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" class="force-full-width" bgcolor="#414141" style="margin: 0 auto">
                  ...
                  <tr>
                    <td style="color:#bbbbbb; font-size:12px;">
                      <a href="#">View in browser</a> | <a href="#">Unsubscribe</a> | <a href="<?php echo base_url().'contactus'; ?>">Contact</a>
                      <br><br>
                    </td>
                  </tr>
                  <tr>
